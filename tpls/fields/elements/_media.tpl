<span class="cctm_media" id="cctm_post_[+post_id+]">
	...
	<table>
		<tr>
			<td>
				...
				<!--a href="[+preview_url+]" target="_blank" title="[+preview+]"><img class="mini-thumbnail" src="[+src_tiny_thumb+]" height="30" width="30" alt="[+preview+]" /></a-->
