...
//	private $media_type_option_tpl = '<li><span onclick="javascript:search_media(\'[+mime_type+]\');">[+mime_type_label+] <span class="mime_type_count">([+count+])</span> &nbsp;</li>';
	...
	private function _format_attachment_result($r)
	{
		...
		$preview_html = htmlentities($preview_html); // in case the description has quotes in it.
		$preview_html .= '<span class="formgenerator_label">'
			. $r['post_title']
			.' <span class="formgenerator_id_label">('.$r['post_id'].')</span></span><br />';
