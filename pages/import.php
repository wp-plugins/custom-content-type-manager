...
$info = self::get_value($candidate, 'export_info');
...
//------------------------------------------------------------------------------
?>
		<h3><?php print self::get_value($info, 'title'); ?></h3>
		<table>
			<tr><td>Author:</td><td><?php print self::get_value($info, 'author'); ?></td></tr>
			<tr><td>URL:</td><td><a href="<?php print self::get_value($info, 'url'); ?>"><?php print self::get_value($info, 'url'); ?></a></td></tr>
			<tr><td>Description:</td><td><p><?php print self::get_value($info, 'description'); ?></p></td></tr>
		</table>
<?php 
//------------------------------------------------------------------------------
endif; 
