<tr id="field_<?php print $data['i']; ?>">
    <td><input type="text" name="fields[ <?php print $data['i']; ?> ][name]" class="<?php print $data['name_class']; ?>"
        value="<?php print $data['name']; ?>" placeholder="<?php _e('samplename', CCTM_TXTDOMAIN); ?>"/></td>
