<tr id="cctm_custom_field_<?php print $data['name']; ?>" class="active">
	...
	<td class="column-description desc">
		...
		<div class="active second plugin-version-author-uri">
			<?php print $data['edit_field_link']; ?> | <?php print $data['delete_field_link']; ?> | <?php print $data['manage_associations_link']; ?> | <a href="?page=cctm_fields&a=merge_custom_fields&field=<?php print $data['name'];?>">Merge</a></div>
	</td>
</tr>